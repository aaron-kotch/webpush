...
function M(a) {
  ...
  return s.searchParams.set(E, e), { cacheKey: s.href, url: n.href };
}
class I {
  constructor() {
    (this.updatedURLs = []),
...
class B {
  ...
  async cacheMatch(e) {
    ...
    const { cacheName: n, matchOptions: r } = this._strategy,
      ...
      c = Object.assign(Object.assign({}, r), { cacheName: n });
  ...
  async cachePut(e, t) {
    ...
    const { cacheName: i, matchOptions: c } = this._strategy,
      ...
      g = h ? await q(o, n.clone(), ["__WB_REVISION__"], c) : null;
    try {
...
let y;
const z = () => (
  y || ((y = new Q()), y.addFetchListener(), y.addCacheListener()), y
);
function J(a, e, t) {
  let s;
  if (typeof a == "string") {
...
se([
  { revision: "ab47fcf8707e4c6e7a480159569bd3a2", url: "apple-touch-icon.png" },
  { revision: "bd75d885c8acfe971a2920f89b370f64", url: "favicon.ico" },
  { revision: "befb82638ebfb5c672ec7f706c36f760", url: "pwa-192x192.png" },
  { revision: "65d2283264dbc6fc7c46ed485302b02b", url: "pwa-512x512.png" },
  { revision: "7ca40b4576963651532b55fa9cdcd4d1", url: "manifest.webmanifest" },
]);
"serviceWorker" in navigator &&
  window.addEventListener("load", () => {
    navigator.serviceWorker
      .register("/webpush/my-sw.js")
      .then((e) => {
...
self.addEventListener("push", function (a) {
  console.log("Received an epoi message", a),
    a.waitUntil(
      self.registration.showNotification("Epoi Notification", {
    ...
    .then(function () {
      return self.registration.pushManager.subscribe({
        ...
        applicationServerKey: urlBase64ToUint8Array(
          "BNJW_rLjqk1rS1BI-mK8DWfCHr1PFGeA7d-MAGRn5gpjCpGxgLxW7Pnhnzh_d6ljUQcoyD_dcAgBpru7gGQNpmg"
        ),
      });
    })
    .then(function (a) {
      console.log("Resubscribed to push notifications:", a);
    })
    .catch(function (a) {
      console.error("Failed to resubscribe:", a);
    });
}
